...
bool BasisOnMeshXi<MeshType,BasisFunctionType,DummyForTraits>::
...
bool BasisOnMeshXi<Mesh::StructuredRegularFixedOfDimension<1>, BasisFunctionType>::
pointIsInElement(Vec3 point, element_no_t elementNo, std::array<double,1> &xi)
{
  const int nDofsPerElement = BasisOnMeshBaseDim<1,BasisFunctionType>::nDofsPerElement();  //=2
  std::array<Vec3, nDofsPerElement> geometryValues;
  
  this->getElementGeometry(elementNo, geometryValues);
  const double elementLength = this->meshWidth() * BasisOnMeshBaseDim<1,BasisFunctionType>::averageNNodesPerElement();
...
// regular fixed 2D
template<typename BasisFunctionType>
bool BasisOnMeshXi<Mesh::StructuredRegularFixedOfDimension<2>, BasisFunctionType>::
pointIsInElement(Vec3 point, element_no_t elementNo, std::array<double,2> &xi)
{
  const int nDofsPerElement = BasisOnMeshBaseDim<2,BasisFunctionType>::nDofsPerElement();
  std::array<Vec3, nDofsPerElement> geometryValues;
...
// regular fixed 3D
template<typename BasisFunctionType>
bool BasisOnMeshXi<Mesh::StructuredRegularFixedOfDimension<3>, BasisFunctionType>::
pointIsInElement(Vec3 point, element_no_t elementNo, std::array<double,3> &xi)
{
  const int nDofsPerElement = BasisOnMeshBaseDim<3,BasisFunctionType>::nDofsPerElement();
  std::array<Vec3, nDofsPerElement> geometryValues;
...
bool BasisOnMeshXi<MeshType, BasisFunction::LagrangeOfOrder<1>, Mesh::isDeformableWithDim<1,MeshType>>::
pointIsInElement(Vec3 point, element_no_t elementNo, std::array<double,1> &xi)
{
  const int nDofsPerElement = BasisOnMeshBaseDim<1,BasisFunction::LagrangeOfOrder<1>>::nDofsPerElement();  //=2
  std::array<Vec3, nDofsPerElement> geometryValues;
...
template<typename MeshType>
bool BasisOnMeshXi<MeshType, BasisFunction::LagrangeOfOrder<1>, Mesh::isDeformableWithDim<2,MeshType>>::
pointIsInElement(Vec3 point, element_no_t elementNo, std::array<double,2> &xi)
{
  const int nDofsPerElement = BasisOnMeshBaseDim<2,BasisFunction::LagrangeOfOrder<1>>::nDofsPerElement();  //=4
  std::array<Vec3, nDofsPerElement> geometryValues;
...
template<typename MeshType>
bool ComputeXiApproximation<MeshType, BasisFunction::LagrangeOfOrder<1>, Mesh::isDeformableWithDim<3,MeshType>>::
pointIsInElementQuick(Vec3 point, std::array<Vec3, BasisOnMeshBaseDim<3,BasisFunction::LagrangeOfOrder<1>>::nDofsPerElement()> &geometryValues)
{
...
computeApproximateXiForPoint(Vec3 point, element_no_t elementNo, std::array<double,3> &xi)
{
  ...
  const int nDofsPerElement = BasisOnMeshBaseDim<3,BasisFunction::LagrangeOfOrder<1>>::nDofsPerElement();  //=8
  std::array<Vec3, nDofsPerElement> geometryValues;
