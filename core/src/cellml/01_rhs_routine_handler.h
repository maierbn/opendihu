...
protected:
  ...
  void (*rhsRoutineGPU_)(double VOI, double* OC_STATE, double* OC_RATE, double* OC_WANTED, double* OC_KNOWN);   ///< function pointer to a gpu processed rhs function that is passed as dynamic library. Computes rates and intermediate values from states. The parameters are: VOI, STATES, RATES, WANTED, KNOWN, (VOI: current simulation time, not used)
