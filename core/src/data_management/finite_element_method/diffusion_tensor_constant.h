...
public:
  ...
  const MathUtility::Matrix<FunctionSpaceType::dim(),FunctionSpaceType::dim(),double_v_t> diffusionTensor(element_no_v_t elementNoLocal, const std::array<double,FunctionSpaceType::dim()> xi) const;
