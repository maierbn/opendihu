#include "data_management/specialized_solver/fast_monodomain_solver.h"
...
FastMonodomainSolver<FunctionSpaceType>::
FastMonodomainSolver(DihuContext context) :
  Data<FunctionSpaceType>::Data(context)
{
}

template<typename FunctionSpaceType>
void FastMonodomainSolver<FunctionSpaceType>::
...
createPetscObjects()
{
  LOG(DEBUG) << "FastMonodomainSolver::createPetscObject for " << nCompartments_ << " compartments.";
...
template<typename FunctionSpaceType>
std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceType,3>> FastMonodomainSolver<FunctionSpaceType>::
fiberDirection()
{
...
template<typename FunctionSpaceType>
std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceType,1>> FastMonodomainSolver<FunctionSpaceType>::
flowPotential()
{
...
template<typename FunctionSpaceType>
std::vector<std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceType,1>>> FastMonodomainSolver<FunctionSpaceType>::
...
template<typename FunctionSpaceType>
typename FastMonodomainSolver<FunctionSpaceType>::FieldVariablesForOutputWriter FastMonodomainSolver<FunctionSpaceType>::
