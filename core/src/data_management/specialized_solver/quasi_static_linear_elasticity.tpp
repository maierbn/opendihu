...
createPetscObjects()
{
  ...
  this->activeStress_ = this->functionSpace_->template createFieldVariable<9>("active stress");
}

template<typename DataLinearElasticityType>
std::shared_ptr<QuasiStaticLinearElasticity<DataLinearElasticityType>::FieldVariableType> QuasiStaticLinearElasticity<DataLinearElasticityType>::
activation()
{
...
template<typename DataLinearElasticityType>
std::shared_ptr<QuasiStaticLinearElasticity<DataLinearElasticityType>::StressFieldVariableType> QuasiStaticLinearElasticity<DataLinearElasticityType>::
activeStress()
{
...
getOutputFieldVariables()
{
  return std::tuple_cat(
    ...
    std::tuple<std::shared_ptr<FieldVariableType>>(this->activeStress_),
  );
}
