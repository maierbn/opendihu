...
struct HyperelasticityBase
{
  ...
  // note, the order of VAR(0) - VAR(13) is reflected in the code and cannot be changed anymore
  ...
  static constexpr auto Ibar4 = VAR(2); //< 4th reduced or modified strain invariant Ibar4 = a0•C a0
  static constexpr auto Ibar5 = VAR(3); //< 5th reduced or modified strain invariant Ibar5 = a0•C^2 a0
...
struct HyperelasticTendon : HyperelasticityBase
{
  ...
  //! the isochoric part of the decoupled strain energy function, Ψ_iso(Ibar1,Ibar2,Ibar4,Ibar5), in terms of the reduced invariants
  static const auto constexpr strainEnergyDensityFunctionIsochoric = psi_NH + psi_f;
  ...
  //! another coupled form of the strain energy function, Ψ(C), dependent on right Cauchy Green tensor, C
  //! it must only depend on variables C11, C12, C13, C22, C23, C33.
  static const auto constexpr strainEnergyDensityFunctionCoupledDependentOnC = psi_Fung;
};
