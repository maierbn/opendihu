...
std::array<dof_no_t,FunctionSpaceFunction<MeshType,BasisFunctionType>::nDofsPerElement()> FunctionSpaceElementalDofs<MeshType,BasisFunctionType>::
...
template<typename MeshType, typename BasisFunctionType>
std::array<Vc::int_v,FunctionSpaceFunction<MeshType,BasisFunctionType>::nDofsPerElement()> FunctionSpaceElementalDofs<MeshType,BasisFunctionType>::
...
template<typename MeshType, typename BasisFunctionType>
void FunctionSpaceElementalDofs<MeshType,BasisFunctionType>::
