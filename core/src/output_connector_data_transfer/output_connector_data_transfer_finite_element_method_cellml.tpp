...
{
  Data::FieldVariableComponent<FunctionSpaceType1,1> scaledFieldVariableComponent1;
...
>::transfer(const OutputConnectorDataType1 &transferableSolutionData1,
            ...
            const std::string transferSlotName)
{
  Data::FieldVariableComponent<FunctionSpaceType2,1> scaledFieldVariableComponent2;
