...
void SolutionVectorMapping<
  std::vector<std::shared_ptr<Data::OutputConnectorData<FunctionSpaceType1,nComponents1a,nComponents1b>>>,   // <fieldVariableType,componentNo,prefactor>
...
>::transfer(const std::shared_ptr<std::vector<std::shared_ptr<Data::OutputConnectorData<FunctionSpaceType1,nComponents1a,nComponents1b>>>> transferableSolutionData1,
            std::shared_ptr<std::pair<std::vector<Vec>,std::vector<std::shared_ptr<FieldVariableType2>>>> transferableSolutionData2,
            OutputConnection &outputConnection)
{
  ...
  const std::vector<std::shared_ptr<Data::OutputConnectorData<FunctionSpaceType1,nComponents1a,nComponents1b>>> &subcellularStates = *transferableSolutionData1;
  ...
  {
    std::shared_ptr<FieldVariableType1> subcellularStatesFieldVariable = subcellularStates[k]->variable1[0].values;   // states variable
    int outputStateIndex = subcellularStates[k]->variable1[0].componentNo;  // is 0
...
void SolutionVectorMapping<
  ...
  std::vector<std::shared_ptr<Data::OutputConnectorData<FunctionSpaceType2,nComponents2a,nComponents2b>>>   // <fieldVariable,componentNo,prefactor>
>::transfer(const std::shared_ptr<std::pair<std::vector<Vec>,std::vector<std::shared_ptr<FieldVariableType1>>>> transferableSolutionData1,  // <Petsc Vecs which are the sub-vectors of a nested vector, transmembranePotential>
            const std::shared_ptr<std::vector<std::shared_ptr<Data::OutputConnectorData<FunctionSpaceType2,nComponents2a,nComponents2b>>>> transferableSolutionData2,
            OutputConnection &outputConnection)
{
  ...
  const std::vector<std::shared_ptr<Data::OutputConnectorData<FunctionSpaceType2,nComponents2a,nComponents2b>>> &subcellularStates = *transferableSolutionData2;
  ...
  for (int k = 0; k < nCompartments; k++)
  {
    std::shared_ptr<FieldVariableType2> subcellularStatesFieldVariable = subcellularStates[k]->variable1[0].values;
    int outputStateIndex = subcellularStates[k]->variable1[0].componentNo;  // is 0
