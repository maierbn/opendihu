...
protected:
  ...
  std::shared_ptr<SpatialDiscretization::DirichletBoundaryConditions<FunctionSpaceType,nComponents>> dirichletBoundaryConditions_; //< the dirichlet boundary conditions object that contains dofs and values of Dirichlet BCs
  ...
  global_no_t nonBcDofNoBegin_;   ///< the first no in the non-bc global numbering
...
#include "partition/partitioned_petsc_vec/partitioned_petsc_vec_with_dirichlet_bc.tpp"
