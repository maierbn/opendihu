...
'''
    ...
    def check(self, ctx):
        ...
        self.set_build_handler([
            ...
            './b2 link=shared variant=release runtime-link=shared cxxflags=-std=c++14 install --prefix=${PREFIX}  --with-system --with-filesystem --with-serialization --with-program_options'
        ])
