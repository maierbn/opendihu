...
'''
  ...
  def check(self, ctx):
    ...
    self.set_build_handler([
      ...
      -DBUILD_CINEEMATICCAMERA_PLUGIN=OFF -DBUILD_GEOMETRY_CALLS_PLUGIN=OFF -DBUILD_GUI_PLUGIN=OFF -DBUILD_IMAGEVIEWER2_PLUGIN=OFF -DBUILD_IMAGE_CALLS_PLUGIN=OFF -DBUILD_INFOVIS_PLUGIN=OFF -DBUILD_MDAO2_PLUGIN=OFF \
      -DBUILD_MMSTD_MOLDYN_PLUGIN=OFF -DBUILD_MMSTD_TRISOUP_PLUGIN=OFF -DBUILD_MMSTD_VOLUME_PLUGIN=OFF -DBUILD_PROTEIN_PLUGIN=OFF -DBUILD_MWDEMOS_PLUGIN=OFF -DBUILD_PROTEIN_CALLS_PLUGIN=OFF -DBUILD_MMSTD_DATATOOLS_PLUGIN=OFF -DUSE_LIBUNWIND=OFF\
