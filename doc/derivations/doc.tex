...
\begin{equation*}
  ...
  \text{with }\sigma_\text{eff}:= \sigma_i || \sigma_e
  \end{array}
\end{equation*}
...
\begin{equation*}
  \begin{array}{l}
	...
	\mathbf{V}_k^{\text{T}} \textbf{I}_{\mathrm{enh}}^{(t)} 
  ...
  \end{array}
\end{equation*}
where $\textbf{FG}(\mathbf{v}_\mathrm{m}, \mathbf{y})$, $\textbf{I}_{\mathrm{enh}}$, and $ \textbf{A}_\mathrm{enh}$
...
\begin{equation*}
  ...
  \end{array}\right],\, 
  \textbf{I}_{\mathrm{enh}} := \left[ \begin{array}{c}
  	\textbf{I}_{\mathrm{stm},1} \vspace{6pt}\\  	
  	\textbf{I}_{\mathrm{stm},2} \vspace{6pt}\\
  	\vdots \\
  	\textbf{I}_{\mathrm{stm},n} \vspace{6pt}\\
  	0 \\
  	\vdots \\  	
  	0 
  \end{array} \right], \,
