...
\begin{equation*}
  \begin{array}{lll}
    \hat{\bfu}^A = \big(\lambda\,l_x - l_x, \dfrac{l_z}{\sqrt{\lambda}} - l_z,\dfrac{l_z}{\sqrt{\lambda}} - l_z\big) = \big((\lambda-1)\,l_x,(\dfrac1{\sqrt{\lambda}}-1)\,l_z,(\dfrac1{\sqrt{\lambda}}-1)\,l_z\big)
  \end{array}
\end{equation*}
