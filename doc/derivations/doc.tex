...
\begin{equation*}
  \begin{array}{lll}
    ...
    \bfu^{(t+1)} &= \bfu^{(t)} + dt \,\bfM^{-1}\bfK\bfu^{(t)}%\\[4mm]
                % &= \Big(\bfI - dt \,\bfM^{-1}\bfK\bf\Big)\bfu^{(t)}
                .
  \end{array}
\end{equation*}
...
\left\{
  \begin{array}{ll}
	m_{i,j}=0 &i\ne j\\
	m_{i,i}=\frac{S}{D} m'_{i,i} & i=1,...,n
  \end{array}
\end{equation}
where $S=\sum_{i=1}^{n}\sum_{j=1}^{n} m'_{i,j}$ and $D=\sum_{i=1}^{n}m'_{i,i}$.
