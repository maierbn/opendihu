...
* To execute some of the more advanced electrophysiology examples, you'll need special input files like a muscle geometry. 
  These are too large to have in git. `Download the file <https://ipvs.informatik.uni-stuttgart.de/cloud/s/LGdatFXDnc2yJKb>`_ and unpack it in the ``examples/electrophysiology/input`` directory.
