...
import math
SCENARIO = 'diffusion1d'

log_filename = "build_debug/logs/diffusion1d_log.csv"
...
name = "none"
ranks = 0
raw_data.append({'scenarioName': "Dummy", 'nRanks': '-1', 'totalUsertime' : 0 })
...
output_file = SCENARIO + '_weak_scaling.png'
output_path = ""
