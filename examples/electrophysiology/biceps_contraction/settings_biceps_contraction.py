...
config = {
  ...
  "Coupling": {
    ...
    "connectedSlotsTerm1To2": [0],          # transfer Vm to MuscleContractionSolver
    ...
    "Term2": {        # solid mechanics
      ...
      "OutputWriter" : [
        {"format": "Paraview", "outputInterval": 1, "filename": "out/mechanics", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True},
      ],
