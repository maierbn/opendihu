...
config = {
  "ExplicitEuler" : {
    ...
    "CellML" : {
      ...
      "modelFilename": "shorten_ocallaghan_davidson_soboleva_2007.c",         # input C++ source file, can be either generated by OpenCMISS or OpenCOR from cellml model
      #"simdSourceFilename" : "simdcode.cpp",                                 # filename of the transformed C++ source file that gets generated from modelFilename and is ready for multiple instances
