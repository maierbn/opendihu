...
if scenario_name == "Strong_scaling":
  ...
  solver_type = sys.argv[4]
  preconditioner_type = sys.argv[5]
  #cycle_type= sys.argv[6]
  #n_levels = (int)(sys.argv[7])
  end_time = 1.0
      ...
      "Term2": {     # Diffusion
        "CrankNicolson" : {
          ...
          "OutputWriter" : [
            ...
            {"format": "PythonFile", "filename": "out/fibre_"+scenario_name+"_"+str(i), "outputInterval": int(1./dt_1D*output_timestep), "binary":False, "onlyNodalValues":True},
          ]
        },
      },
    }
