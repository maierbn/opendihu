...
#dt_bidomain = 1e-2                  # [ms] timestep width of multidomain, previously dt_bidomain
dt_3D = 1e-2
#dt_splitting_0D1D = 1e-3            # [ms] overall timestep width of strang splitting, previously dt_splitting_0D1D
dt_splitting = 1e-3
dt_elasticity = 1e-3# 1e0                 # [ms] time step width of elasticity solver

#output_timestep_3D = 1e0
...
#added to two_muscles_with_tendons
