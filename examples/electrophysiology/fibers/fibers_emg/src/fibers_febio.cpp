...
int main(int argc, char *argv[])
{
  ...
  Control::Coupling<
    FastMonodomainSolver<                        // a wrapper that improves performance of multidomain
        ...
        OperatorSplitting::Strang<
          Control::MultipleInstances<
            TimeSteppingScheme::Heun<                   // fiber reaction term
              CellmlAdapter<
                57,71,  // nStates,nAlgebraics: 57,1 = Shorten, 57,71 = Shorten slow_TK, 4,9 = Hodgkin Huxley
      ...
      >
    >,
    TimeSteppingScheme::QuasiStaticNonlinearElasticitySolverFebio              // nonlinear elasticity by FEBio external solver
  > problem(settings);
