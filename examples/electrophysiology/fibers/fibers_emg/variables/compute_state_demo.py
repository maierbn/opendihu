...
scenario_name = "compute_state_demo"
...
motor_units = [
  {"radius": 40.00, "activation_start_time": 0.00, "stimulation_frequency": 10, "jitter": [0.1*random.uniform(-1,1) for i in range(100)]},    # low number of fibers
...
# timing parameters
# -----------------
end_time = 70.0                      # [ms] end time of the simulation
