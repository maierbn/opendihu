...
output_timestep = 1e-4              # [ms] timestep for output surface EMG, 0.5
output_timestep_fibers = 1e-4       # [ms] timestep for fiber output, 0.5
output_timestep_3D_emg = 1e-4            # [ms] timestep for output big files of 3D EMG, 100
...
#fiber_file              = input_directory+"/left_biceps_brachii_23x23fibers.bin"
