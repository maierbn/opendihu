...
for mu_no in range(n_motor_units):
  ...
  motor_units.append(
  {
    ...
    "activation_start_time": 0.02*mu_no,              # [s] when to start activating this motor unit, here it is a ramp
...
fiber_file              = input_directory+"/left_biceps_brachii_67x67fibers.bin"
...
fiber_distribution_file = input_directory+"/MU_fibre_distribution_67x67_100.txt"
