...
# get mu to activate from argument
if len(sys.argv) <= 3:
  print("Error! Specify which MU to activate (1-20)")
  quit()
mu_no_activate = (int)(sys.argv[1])

# scenario name for log file
scenario_name = "20mus_activate_only_mu_{}".format(mu_no_activate)
...
# True: set high priority to make subdomains have an equal number of nodes, however, this potentially creates tiny remainder elements inside the subdomains
