...
dt_1D = 1e-3    # 1e-4                  # timestep width of diffusion
dt_0D = 1e-3    # 1e-5                 # timestep width of ODEs
...
config = {
  ...
  "RepeatedCall": {
    "timeStepWidth":          output_timestep,
    "timeStepOutputInterval": 1,
    "endTime":                end_time,
    "MultipleInstances": {
      "ranksAllComputedInstances":  [0,1,2,3],
        ...
        "StrangSplitting": {
          ...
          "Term1": {      # CellML, i.e. reaction term of Monodomain equation
            "MultipleInstances": {
              ...
              "instances": 
              [{
                "ranks":                          [j],    # these rank nos are local nos to the outer instance of MultipleInstances, i.e. from 0 to number of ranks in z direction
                "Heun" : {
                  ...
                  "CellML" : {
                    ...
                    "stimulationLogFilename":                 "stimulation.log",
                  },
                },
              } for j in range(2)],
            }
          ...
          "Term2": {     # Diffusion
            "MultipleInstances": {
              ...
              "OutputWriter": [
                {"format": "Paraview", "outputInterval": int(1./output_timestep*output_timestep), "filename": "out/fast_fibers", "binary": True, "fixedFormat": False, "combineFiles": True, "onlyNodalValues": True, "fileNumbering": "incremental"}
              ]
            },
          },
        }
    ...
    "valueForStimulatedPoint":  vm_value_stimulated,                                   # to which value of Vm the stimulated node should be set
  }
}
