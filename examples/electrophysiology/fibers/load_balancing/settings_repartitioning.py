        ...
        "StrangSplitting": {
          ...
          "Term1": {      # CellML
            "HeunAdaptive" : {
              ...
              "additionalSlotNames": [],
              "timeStepWidthsLogFilename": "out/dt_dt.{}.csv".format(i),     # filename for timestep widths, set to None to not capture timestep widths
          ...
          "Term2": {     # Diffusion
            "ImplicitEuler" : {
              ...
              "OutputWriter" : [
                ...
                #{"format": "Paraview", "outputInterval": 1, "filename": "out/fiber_"+str(i), "binary": True, "fixedFormat": False, "combineFiles": False, "fileNumbering": "incremental"},
