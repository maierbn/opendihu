...
config = {
  ...
  "Coupling": {
    ...
    "connectedSlotsTerm1To2": [0,1] if variables.linear_elasticity else [0],  # elasticity: transfer state (Vm) and intermediate (gamma) to elasticity, fibers_emg: transfer Vm to StaticBidomainSolver
    "connectedSlotsTerm2To1": []    if variables.linear_elasticity else [None],   # elasticity: only transfer back geometry (this happens automatically),   fibers_emg: transfer nothing back
