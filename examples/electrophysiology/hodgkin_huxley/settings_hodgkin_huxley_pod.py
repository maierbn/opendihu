...
n_elements = 100 # number of elements of physical mesh
n_total = n_elements   # number of rows of the snapshot matrix
n_reduced = n_elements  # number of reduced bases, columns of the left singular vector
# note: you had 403 here, but is the reduced function space should only be for the Vm component, note for the 3 others
