        ...
        "StrangSplitting": {
              ...
              [{
                ...
                "Heun" : {
                  ...
                  "CellML" : {
                    ...
                    "statesForTransfer":                      0,            # which intermediate values to use in further computation
                    "intermediatesForTransfer":               0,                   # which state values to use in further computation, Shorten / Hodgkin Huxley: state 0 = Vm
          ...
          "Term2": {     # Diffusion
            "MultipleInstances": {
              ...
              "OutputWriter" : [
                {"format": "PythonFile", "outputInterval": int(1./dt_splitting*output_timestep), "filename": "out/fast/fibers", "binary": True, "fixedFormat": False, "combineFiles": True}
              ]
            },
          },
        }
