    ...
    "Term1": {      # CellML
      "Heun" : {
        ...
        "CellML" : {
          ...
          "optimizationType": "vc",
          "approximateExponentialFunction": False,     # only if "optimizationType" is "vc", approximate the exp(x) function by (1+x/n)^n, n=1024, this is way faster than the exact exp()-function
          #"libraryFilename": "cellml_simd_lib.so",   # compiled library
          "compilerFlags": "-fPIC -shared -O3",
          #"statesInitialValues": [],
