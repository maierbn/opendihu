...
config = {
  ...
  "MappingsBetweenMeshes": {
    "3Dmesh": [
       ...
       {"name": "3Dmesh_elasticity_quadratic+3DFatMesh_elasticity_quadratic",  "xiTolerance": 0.5, "enableWarnings": False, "compositeUseOnlyInitializedMappings": True, "fixUnmappedDofs": True, "defaultValue": 1},    # mapping uses mappings of submeshes (i.e. 3Dmesh_elasticity_quadratic->3Dmesh)
    ],
    "3DFatMesh":  [
  ...
  "Coupling": {
    ...
    "endTime":                1,
    "connectedSlotsTerm1To2": {0:0, 1:2},      # connect lambda to slot 0 and gamma to slot 2
