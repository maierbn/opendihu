...
#material_parameters = [1, 0, 0, 1]
pmax = 7.3                  # [N/cm^2] maximum isometric active stress
constant_gamma = 0.3    # 0.3 works

# load
precontraction_constant_body_force = (0,0,-9.81e-4)   # [cm/ms^2], gravity constant for the body force
precontraction_constant_body_force = (0,0,20*9.81e-4)   # [cm/ms^2], gravity constant for the body force
#constant_body_force = (20*9.81e-4,  10*9.81e-4,  80*9.81e-4)   # [cm/ms^2], body force upwards
