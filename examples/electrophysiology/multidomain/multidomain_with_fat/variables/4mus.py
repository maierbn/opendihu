#   multidomain_with_fat_emg ../settings_multidomain_with_fat.py 4mus.py multidomain
...
n_motor_units = 20   # number of motor units, only the first 4 are used
...
fiber_file              = input_directory + "/left_biceps_brachii_33x33fibers.bin".format(n_fibers_x, n_fibers_x)
