...
if rank_no == 0:
  ...
  print("dt_0D:           {:0.0e}    multidomain solver:         {} ({}), lumped mass matrix: {}".format(variables.dt_0D, variables.multidomain_solver_type, variables.multidomain_alternative_solver_type, variables.use_lumped_mass_matrix))
