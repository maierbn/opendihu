...
motor_units = [
  {"fiber_no": 10, "standard_deviation": 2.0, "maximum": 0.5, "activation_start_time": 0.0, "stimulation_frequency": 10.0,},
  {"fiber_no": 30, "standard_deviation": 2.0, "maximum": 0.4, "activation_start_time": 0.0, "stimulation_frequency": 10.0,},
  {"fiber_no": 40, "standard_deviation": 3.0, "maximum": 0.6, "activation_start_time": 0.0, "stimulation_frequency": 10.0,},
]

end_time = 4000.0                   # [ms] end time of the simulation
stimulation_frequency = 100*1e-3    # [ms^-1] sampling frequency of stimuli in firing_times_file, in stimulations per ms, number before 1e-3 factor is in Hertz.
dt_0D = 2.5e-3                        # [ms] timestep width of ODEs (3e-3)
dt_multidomain = 1e-2               # [ms] timestep width of multidomain
dt_splitting = 1e-2                 # [ms] overall timestep width of strang splitting (3e-3)
output_timestep = 1e-2              # [ms] timestep for output big files of 3D EMG, 100
