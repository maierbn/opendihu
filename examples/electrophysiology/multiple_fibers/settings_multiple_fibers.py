      ...
      "Term2": {     # Diffusion
        "ImplicitEuler" : {
          ...
          "OutputWriter" : [
            ...
            {"format": "PythonFile", "outputInterval": int(1./variables.dt_1D*variables.output_timestep), "filename": "out/fibre_"+str(i), "binary": True, "onlyNodalValues":False}, # also derivatives for hermite
