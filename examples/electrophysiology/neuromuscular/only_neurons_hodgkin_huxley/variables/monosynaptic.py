...
# muscle spindles
n_muscle_spindles = 1
muscle_spindle_cellml_file = "../../../input/mileusenic_muscle_spindle.cellml"
muscle_spindle_mappings = {
  ...
  ("connectorSlot", 0): "modell/primary_afferent",          # Ia Afferent firing frequency
  ("connectorSlot", 1): "modell/L",                         # Mechanical stimulus stimulation (Why are the inputs set as output?)
}
