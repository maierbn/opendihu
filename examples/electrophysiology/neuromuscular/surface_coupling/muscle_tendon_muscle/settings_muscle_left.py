...
config = {
  ...
  "PreciceAdapter" : {
    ...
    "preciceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
      {
        "preciceMeshName":      "Muscle1Mesh",         # precice name of the 2D coupling mesh
    ...
    "preciceData": [
      {
        ...
        "preciceMeshName":      "Muscle1Mesh",                 # name of the precice coupling surface mesh, as given in the precice xml settings file
      ...
      },
      {
        ...
        "preciceMeshName":      "Muscle1Mesh",                 # name of the precice coupling surface mesh, as given in the precice xml settings 
