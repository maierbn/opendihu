...
muscle_meshes = {
  ...
  "muscle2Mesh": {
    ...
    "physicalOffset":     variables.muscle2_offset,
    "logKey":             "muscle2",
...
config = {
  ...
  "PreciceAdapter" : {
    ...
    "preciceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
      {
        "preciceMeshName":      "Muscle2Mesh",         # precice name of the 2D coupling mesh
    ...
    "preciceData": [
      {
        ...
        "preciceMeshName":      "Muscle2Mesh",                 # name of the precice coupling surface mesh, as given in the precice xml settings file
      ...
      },
      {
        ...
        "preciceMeshName":      "Muscle2Mesh",                 # name of the precice coupling surface mesh, as given in the precice xml settings 
                      ...
                      "instances": [
                        {
                          ...
                          "Heun" : {
                            ...
                            "OutputWriter" : [
                              {"format": "Paraview", "outputInterval": int(variables.dt_elasticity/variables.dt_0D), "filename": "out/" + variables.scenario_name + "/muscle2_0D_states({},{})".format(fiber_in_subdomain_coordinate_x,fiber_in_subdomain_coordinate_y), "binary": True, "fixedFormat": False, "combineFiles": True}
