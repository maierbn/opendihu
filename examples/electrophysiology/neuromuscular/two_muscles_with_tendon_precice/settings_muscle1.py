...
# TODO: Define BC, fix z coordinate at the extreme of the muscle which is not attached to the wall

variables.elasticity_dirichlet_bc = {}
k = 0 # write mz-1 in case of muscle 2
...
config = {
  ...
  "logFormat":             "csv",
  "solverStructureDiagramFile":     "out/muscle1_solver_structure.txt",     # output file of a diagram that shows data connection between solvers
  "mappingsBetweenMeshesLogFile":   "out/muscle1_mappings_between_meshes.txt",  # log file of when mappings between meshes occur
  ...
  "PreciceAdapter": {        # precice adapter for muscle
    ...
    "preciceParticipantName":   "Muscle1Solver",             # name of the own precice participant, has to match the name given in the precice xml config file
    ...
    "preciceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
      {
        "preciceMeshName":      "Muscle1MeshRight",         # precice name of the 2D coupling mesh
    ...
    "preciceData": [
      {
        ...
        "preciceMeshName":      "Muscle1MeshRight",                 # name of the precice coupling surface mesh, as given in the precice xml settings file
      ...
      },
      {
        ...
        "preciceMeshName":      "Muscle1MeshRight",                 # name of the precice coupling surface mesh, as given in the precice xml settings 
