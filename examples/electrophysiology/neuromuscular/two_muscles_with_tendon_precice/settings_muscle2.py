...
k = mz-1 # write 0 in case of muscle 1
...
config = {
  ...
  "logFormat":             "csv",
  "solverStructureDiagramFile":     "out/muscle2_solver_structure.txt",     # output file of a diagram that shows data connection between solvers
  "mappingsBetweenMeshesLogFile":   "out/muscle2_mappings_between_meshes.txt",  # log file of when mappings between meshes occur
  ...
  "PreciceAdapter": {        # precice adapter for muscle
    ...
    "preciceParticipantName":   "Muscle2Solver",             # name of the own precice participant, has to match the name given in the precice xml config file
    ...
    "preciceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
      {
        "preciceMeshName":      "Muscle2MeshLeft",         # precice name of the 2D coupling mesh
    ...
    "preciceData": [
      {
        ...
        "preciceMeshName":      "Muscle2MeshLeft",                 # name of the precice coupling surface mesh, as given in the precice xml settings file
      ...
      },
      {
        ...
        "preciceMeshName":      "Muscle2MeshRight",                 # name of the precice coupling surface mesh, as given in the precice xml settings 
