...
parser.add_argument('--dt_bidomain',                               help='The timestep for the 3D model, i.e. dynamic solid mechanics.', type=float, default=variables.dt_bidomain)
...
if rank_no == 0:
  ...
  print("dt_splitting:    {:0.0e}, emg_solver_type:            {}, emg_initial_guess_nonzero: {}".format(variables.dt_splitting_0D1D, variables.emg_solver_type, variables.emg_initial_guess_nonzero))
  print("dt_bidomain:           {:0.0e}, paraview_output: {}".format(variables.dt_bidomain, variables.paraview_output))
    ...
    "Coupling": {
                ...
                "MultipleInstances": {
                  ...
                  [{
                    ...
                    "PrescribedValues": {
                      ...
                      "OutputWriter" : [
                        {"format": "Paraview", "outputInterval": int(1./variables.dt_bidomain*variables.output_timestep_fibers), "filename": "out/" + variables.scenario_name + "/prescribed_fibers", "binary": True, "fixedFormat": False, "combineFiles": True, "fileNumbering": "incremental"}
                      ]
                    },      
                  } for fiber_in_subdomain_coordinate_y in range(n_fibers_in_subdomain_y(subdomain_coordinate_y)) \
                      for fiber_in_subdomain_coordinate_x in range(n_fibers_in_subdomain_x(subdomain_coordinate_x)) \
                  ...
                  #"OutputWriter" : variables.output_writer_fibers,
                  "OutputWriter": [
                    {"format": "Paraview", "outputInterval": int(1./variables.dt_bidomain*variables.output_timestep_fibers), "filename": "out/" + variables.scenario_name + "/fibers", "binary": True, "fixedFormat": False, "combineFiles": True, "fileNumbering": "incremental"}
                  ]
                }
              },
      ...
      "Term2": {        # solid mechanics
        "MuscleContractionSolver": {
          ...
          "slotNames":                    [],                        # names of the data connector slots
          "OutputWriter" : [
            {"format": "Paraview", "outputInterval": int(1./variables.dt_bidomain*variables.output_timestep), "filename": "out/" + variables.scenario_name + "/mechanics_3D", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
          ],
          ...
          "DynamicHyperelasticitySolver": {
            "timeStepWidth":              variables.dt_bidomain,           # time step width 
            ...
            "dynamic": {    # output of the dynamic solver, has additional virtual work values 
              "OutputWriter" : [   # output files for displacements function space (quadratic elements)
                ...
                {"format": "Paraview", "outputInterval": int(1./variables.dt_bidomain*variables.output_timestep), "filename": "out/"+variables.scenario_name+"/virtual_work", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
              ],
            },
