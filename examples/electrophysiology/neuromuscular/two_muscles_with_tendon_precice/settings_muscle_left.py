...
config = {
  "scenarioName":                   "muscle_left",    # scenario name which will appear in the log file
 ...
 "PreciceAdapter": {        # precice adapter for muscle
    ...
    "preciceConfigFilename":    "precice_config_two_mucles_with_tendon.xml",    # the preCICE configuration file
    ...
    "Term1": {
      "MultipleCoupling": {
          ...
          "MapDofs": {
            ...
            "afterComputation": [                                         # transfer/mapping of dofs that will be performed after the computation of the nested solver
              ...
              # ms_out = primary_afferent is max(0, value) an can therefore be zero
              {
                ...
                "dofsMapping":                      None,
                "inputDofs":                        muscle_left_spindle_indices,   # [0,1,...,n_muscle_spindles], this is for mesh "muscleSpindleMesh"
                "outputDofs":                       [in_ms_mesh_muscle_left_motoneuron_indices],   # [0,1,...,n_motor_neurons], this is for mesh "motoneuronMesh"
                ...
                "toDofNosNumbering":                "local",
                "dofsMapping":                      None,
                "inputDofs":                        muscle_right_spindle_indices,   # [0,1,...,n_muscle_spindles], this is for mesh "muscleSpindleMesh"
                "outputDofs":                       [in_ms_mesh_muscle_right_motoneuron_indices],   # [0,1,...,n_motor_neurons], this is for mesh "motoneuronMesh"
                "callback":                         variables.callback_muscle_spindles_to_motoneurons,
              }
            ],
            ...
            "beforeComputation": [                                        # transfer/mapping of dofs that will be performed before the computation of the nested solver
              {
                ...
                "toDofNosNumbering":                "local",
                "dofsMapping":                      None,
                "inputDofs":                        in_ms_mesh_muscle_left_motoneuron_indices + in_ms_mesh_interneuron_indices,   # [0,1,...,n_muscle_spindles,...,n_muscle_spindles+n_interneurons]
                "outputDofs":                       [muscle_left_motoneuron_indices],   # [0,1,...,n_motoneurons]
              ...
              },
              {
                ...
                "toDofNosNumbering":                "local",
                "dofsMapping":                      None,
                "inputDofs":                        in_ms_mesh_muscle_right_motoneuron_indices + in_ms_mesh_interneuron_indices,   # [0,1,...,n_muscle_spindles,...,n_muscle_spindles+n_interneurons]
                "outputDofs":                       [muscle_right_motoneuron_indices],   # [0,1,...,n_motoneurons]
                "callback":                         variables.callback_motoneurons_input,
              }
            ],
        ...
        # muscle_left: bidoamin + 1D monodomain + 0D
        "Term5": {
          ...
          "MapDofs": {
            ...
            "beforeComputation": [                                        # transfer/mapping of dofs that will be performed before the computation of the nested solver
              {
                ...
                "dofsMapping":                      {muscle_left_motoneuron_indices[motor_unit_no]: stimulation_node_nos},   # map from the motor unit to the stimulated node of the fiber mesh
            ...
            "Coupling": {
              ...
              "durationLogKey":         "duration_total_muscle_left",
              ...
              "Term1": {
                "MultipleInstances": {
                  "logKey":                     "duration_subdomains_xy_muscle_left",
                  ...
                  "instances": [
                    {
                      ...
                      "StrangSplitting": {
                        ...
                        "durationLogKey":         "duration_monodomain_muscle_left",
                        "timeStepOutputInterval": 100,
                        ...
                        "Term1": {
                          "MultipleInstances": {
                            "logKey":             "duration_subdomains_z_muscle_left",
                            ...
                            "instances": [
                              {
                                ...
                                "Heun" : {
                                  ...
                                  "durationLogKey":               "duration_0D_muscle_left",                           # log key of duration for this solver
                                  ...
                                  "CellML" : {
                                    ...
                                    "mappings":                               variables.muscle_left_mappings,                             # mappings between parameters and algebraics/constants and between outputConnectorSlots and states, algebraics or parameters, they are defined in helper.py

                                    "meshName":                               "muscle_left_fiber{}".format(fiber_no),                # reference to the fiber mesh
                                    "stimulationLogFilename":                 "out/" + variables.scenario_name + "/stimulation_muscle_left.log",                          # a file that will contain the times of stimulations
                                  },
                                  "OutputWriter" : [
                                    {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.scenario_name + "/muscle_left_0D_states({},{})".format(fiber_in_subdomain_coordinate_x,fiber_in_subdomain_coordinate_y), "binary": True, "fixedFormat": False, "combineFiles": True}
                        ...
                        "Term2": {
                          "MultipleInstances": {
                            ...
                            "instances": [
                              {
                                ...
                                "ImplicitEuler": {
                                  ...
                                  "durationLogKey":              "duration_1D_muscle_left",                           # log key of duration for this solver
                                  ...
                                  "FiniteElementMethod" : {
                                    "inputMeshIsGlobal":         True,
                                    "meshName":                  "muscle_left_fiber{}".format(fiber_no),
                            ...
                            "OutputWriter" : variables.output_writer_fibers_muscle_left,
                          },
                        },
                      }
              ...
              "Term2": {        # Bidomain, EMG
                "OutputSurface": {        # version for fibers_emg_2d_output
                  "OutputWriter": [
                    {"format": "Paraview", "outputInterval": int(1./variables.dt_bidomain*variables.output_timestep_surface), "filename": "out/" + variables.scenario_name + "/muscle_left_surface_emg", "binary": True, "fixedFormat": False, "combineFiles": True, "fileNumbering": "incremental",},
                  ...
                  "filename":                 "out/{}/muscle_left_electrodes.csv".format(variables.scenario_name),
                  ...
                  "StaticBidomainSolver": {
                    ...
                    "timeStepOutputInterval": 50,
                    "durationLogKey":         "duration_bidomain_muscle_left",
                    ...
                    "OutputWriter" : variables.output_writer_emg_muscle_left,
                  }
                }
              }
            }
      ...
      "MapDofs": {
        ...
        "afterComputation": [       # transfer/mapping of dofs that will be performed before the computation of the nested solver
          ...
          # call callback_muscle_spindles_input
          {
            ...
            "toDofNosNumbering":                "local",
            "dofsMapping":                      None,
            "inputDofs":                        muscle_left_spindle_node_nos,
            "outputDofs":                       [muscle_left_spindle_indices] * 5,   # dofs for each slot
          ...
          },
          {
            ...
            "toDofNosNumbering":                "local",
            "dofsMapping":                      None,
            "inputDofs":                        muscle_right_spindle_node_nos,
            "outputDofs":                       [muscle_right_spindle_indices] * 5,   # [0,1,...,n_muscle_spindles]*5
            "callback":                         variables.callback_muscle_spindles_input,
          },
        ],
        ...
        "MapDofs": {
          ...
          "afterComputation": [                                        # transfer/mapping of dofs that will be performed before the computation of the nested solver
            {
              ...
              "toDofNosNumbering":                "local",
              "dofsMapping":                      None,
              "inputDofs":                        muscle_left_golgi_tendon_organ_node_nos,          # nodes are set at bottom in helper.py
              "outputDofs":                       [muscle_left_golgi_tendon_organ_indices],   # [0,1,...,n_golgi_tendon_organs]
          ...
          "MuscleContractionSolver": {
            ...
            "OutputWriter" : [
              {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/" + variables.scenario_name + "/muscle_left_contraction", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles": True, "fileNumbering": "incremental"},
            ],
            "mapGeometryToMeshes":          ["muscle_leftMesh"] + [key for key in fiber_meshes.keys() if "muscle_left_fiber" in key],    # the mesh names of the meshes that will get the geometry transferred
            ...
            "DynamicHyperelasticitySolver": {
              ...
              "durationLogKey":             "muscle_left_duration_mechanics",               # key to find duration of this solver in the log file
              ...
              "residualNormLogFilename":    "out/"+variables.scenario_name+"/muscle_left_log_residual_norm.txt",   # log file where residual norm values of the nonlinear solver will be written
              ...
              "meshName":                   "muscle_leftMesh_quadratic",       # name of the 3D mesh, it is defined under "Meshes" at the beginning of this config
              ...
              "dirichletBoundaryConditions": variables.muscle_left_elasticity_dirichlet_bc,   # the initial Dirichlet boundary conditions that define values for displacements u and velocity v
              "neumannBoundaryConditions":   variables.muscle_left_elasticity_neumann_bc,     # Neumann boundary conditions that define traction forces on surfaces of elements
              "divideNeumannBoundaryConditionValuesByTotalArea": True,            # if the given Neumann boundary condition values under "neumannBoundaryConditions" are total forces instead of surface loads and therefore should be scaled by the surface area of all elements where Neumann BC are applied
              "updateDirichletBoundaryConditionsFunction": None,                  # muscle_left_update_dirichlet_boundary_conditions_helper, function that updates the dirichlet BCs while the simulation is running
              "updateDirichletBoundaryConditionsFunctionCallInterval": 1,         # every which step the update function should be called, 1 means every time step
              "updateNeumannBoundaryConditionsFunction":   muscle_left_update_neumann_boundary_conditions_helper,                    # function that updates the Neumann BCs while the simulation is running
              ...
              "dirichletOutputFilename":     "out/"+variables.scenario_name+"/muscle_left_dirichlet_boundary_conditions",     # output filename for the dirichlet boundary conditions, set to "" to have no output
              "totalForceLogFilename":       "out/"+variables.scenario_name+"/muscle_left_tendon_force.csv",              # filename of a log file that will contain the total (bearing) forces and moments at the top and bottom of the volume
              ...
              "OutputWriter" : [
                ...
                # Paraview files
                {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/"+variables.scenario_name+"/muscle_left_displacements", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},

                # Python callback function "postprocess"
                # responsible to model the tendon
                {"format": "PythonCallback", "outputInterval": 1, "callback": variables.muscle_left_postprocess, "onlyNodalValues":True, "filename": "", "fileNumbering":'incremental'},
              ],
              # 2. additional output writer that writes also the hydrostatic pressure
              "pressure": {   # output files for pressure function space (linear elements), contains pressure values, as well as displacements and velocities
                "OutputWriter" : [
                  {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/"+variables.scenario_name+"/muscle_left_pressure", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                ]
              },
              # 3. additional output writer that writes virtual work terms
              "dynamic": {    # output of the dynamic solver, has additional virtual work values
                "OutputWriter" : [   # output files for displacements function space (quadratic elements)
                  {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.scenario_name+"/muscle_left_dynamic", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                  {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/"+variables.scenario_name+"/muscle_left_virtual_work", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                ],
              },
              # 4. output writer for debugging, outputs files after each load increment, the geometry is not changed but u and v are written
              "LoadIncrements": {
                "OutputWriter" : [
                  {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/"+variables.scenario_name+"/muscle_left_load_increments", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                ]
              }
            }
          }
