...
neuron_meshes = {
  ...
  "muscle_rightMesh_quadratic": {
    "nElements" :         [elems // 2 for elems in variables.n_elements_muscle_right],
    "physicalExtent":     variables.muscle_right_extent,
    "physicalOffset":     [0,0,0],
...
config = {
  "scenarioName":                   "muscle_right",    # scenario name which will appear in the log file
 ...
 "PreciceAdapter": {        # precice adapter for muscle
    ...
    "Term1": {
      "MultipleCoupling": {
        ...
        # muscle_right: bidoamin + 1D monodomain + 0D
        "Term5": {
          ...
          "MapDofs": {
            ...
            "beforeComputation": [                                        # transfer/mapping of dofs that will be performed before the computation of the nested solver
              {
                ...
                "dofsMapping":                      {muscle_right_motoneuron_indices[motor_unit_no]: stimulation_node_nos},   # map from the motor unit to the stimulated node of the fiber mesh
            ...
            "Coupling": {
              ...
              "durationLogKey":         "duration_total_muscle_right",
              ...
              "Term1": {
                "MultipleInstances": {
                  "logKey":                     "duration_subdomains_xy_muscle_right",
                  ...
                  "instances": [
                    {
                      ...
                      "StrangSplitting": {
                        ...
                        "durationLogKey":         "duration_monodomain_muscle_right",
                        "timeStepOutputInterval": 100,
                        ...
                        "Term1": {
                          "MultipleInstances": {
                            "logKey":             "duration_subdomains_z_muscle_right",
                            ...
                            "instances": [
                              {
                                ...
                                "Heun" : {
                                  ...
                                  "durationLogKey":               "duration_0D_muscle_right",                           # log key of duration for this solver
                                  ...
                                  "CellML" : {
                                    ...
                                    "mappings":                               variables.muscle_right_mappings,                             # mappings between parameters and algebraics/constants and between outputConnectorSlots and states, algebraics or parameters, they are defined in helper.py

                                    "meshName":                               "muscle_right_fiber{}".format(fiber_no),                # reference to the fiber mesh
                                    "stimulationLogFilename":                 "out/" + variables.scenario_name + "/stimulation_muscle_right.log",                          # a file that will contain the times of stimulations
                                  },
                                  "OutputWriter" : [
                                    {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.scenario_name + "/muscle_right_0D_states({},{})".format(fiber_in_subdomain_coordinate_x,fiber_in_subdomain_coordinate_y), "binary": True, "fixedFormat": False, "combineFiles": True}
                        ...
                        "Term2": {
                          "MultipleInstances": {
                            ...
                            "instances": [
                              {
                                ...
                                "ImplicitEuler": {
                                  ...
                                  "durationLogKey":              "duration_1D_muscle_right",                           # log key of duration for this solver
                                  ...
                                  "FiniteElementMethod" : {
                                    "inputMeshIsGlobal":         True,
                                    "meshName":                  "muscle_right_fiber{}".format(fiber_no),
                            ...
                            "OutputWriter" : variables.output_writer_fibers_muscle_right,
                          },
                        },
                      }
              ...
              "Term2": {        # Bidomain, EMG
                "OutputSurface": {        # version for fibers_emg_2d_output
                  "OutputWriter": [
                    {"format": "Paraview", "outputInterval": int(1./variables.dt_bidomain*variables.output_timestep_surface), "filename": "out/" + variables.scenario_name + "/muscle_right_surface_emg", "binary": True, "fixedFormat": False, "combineFiles": True, "fileNumbering": "incremental",},
                  ...
                  "filename":                 "out/{}/muscle_right_electrodes.csv".format(variables.scenario_name),
                  ...
                  "StaticBidomainSolver": {
                    ...
                    "timeStepOutputInterval": 50,
                    "durationLogKey":         "duration_bidomain_muscle_right",
                    ...
                    "OutputWriter" : variables.output_writer_emg_muscle_right,
                  }
                }
              }
            }
      ...
      "MapDofs": {
        ...
        "afterComputation": [       # transfer/mapping of dofs that will be performed before the computation of the nested solver
          ...
          # call callback_muscle_spindles_input
          {
            ...
            "outputDofs":                       [muscle_right_spindle_indices] * 5,   # dofs for each slot
        ...
        "MapDofs": {
          ...
          "afterComputation": [                                        # transfer/mapping of dofs that will be performed before the computation of the nested solver
            {
              ...
              "toDofNosNumbering":                "local",
              "dofsMapping":                      None,
              "inputDofs":                        muscle_right_golgi_tendon_organ_node_nos,          # nodes are set at bottom in helper.py
              "outputDofs":                       [muscle_right_golgi_tendon_organ_indices],   # [0,1,...,n_golgi_tendon_organs]
          ...
          "MuscleContractionSolver": {
            ...
            "OutputWriter" : [
              {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/" + variables.scenario_name + "/muscle_right_contraction", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles": True, "fileNumbering": "incremental"},
            ],
            "mapGeometryToMeshes":          ["muscle_rightMesh"] + [key for key in fiber_meshes.keys() if "muscle_right_fiber" in key],    # the mesh names of the meshes that will get the geometry transferred
            ...
            "DynamicHyperelasticitySolver": {
              ...
              "durationLogKey":             "muscle_right_duration_mechanics",               # key to find duration of this solver in the log file
              ...
              "residualNormLogFilename":    "out/"+variables.scenario_name+"/muscle_right_log_residual_norm.txt",   # log file where residual norm values of the nonlinear solver will be written
              ...
              "meshName":                   "muscle_rightMesh_quadratic",       # name of the 3D mesh, it is defined under "Meshes" at the beginning of this config
              ...
              "dirichletBoundaryConditions": variables.muscle_right_elasticity_dirichlet_bc,   # the initial Dirichlet boundary conditions that define values for displacements u and velocity v
              "neumannBoundaryConditions":   variables.muscle_right_elasticity_neumann_bc,     # Neumann boundary conditions that define traction forces on surfaces of elements
              "divideNeumannBoundaryConditionValuesByTotalArea": True,            # if the given Neumann boundary condition values under "neumannBoundaryConditions" are total forces instead of surface loads and therefore should be scaled by the surface area of all elements where Neumann BC are applied
              "updateDirichletBoundaryConditionsFunction": None,                  # muscle_right_update_dirichlet_boundary_conditions_helper, function that updates the dirichlet BCs while the simulation is running
              "updateDirichletBoundaryConditionsFunctionCallInterval": 1,         # every which step the update function should be called, 1 means every time step
              "updateNeumannBoundaryConditionsFunction":   muscle_right_update_neumann_boundary_conditions_helper,                    # function that updates the Neumann BCs while the simulation is running
              ...
              "dirichletOutputFilename":     "out/"+variables.scenario_name+"/muscle_right_dirichlet_boundary_conditions",     # output filename for the dirichlet boundary conditions, set to "" to have no output
              "totalForceLogFilename":       "out/"+variables.scenario_name+"/muscle_right_tendon_force.csv",              # filename of a log file that will contain the total (bearing) forces and moments at the top and bottom of the volume
              ...
              "OutputWriter" : [
                ...
                # Paraview files
                {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/"+variables.scenario_name+"/muscle_right_displacements", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},

                # Python callback function "postprocess"
                # responsible to model the tendon
                {"format": "PythonCallback", "outputInterval": 1, "callback": variables.muscle_right_postprocess, "onlyNodalValues":True, "filename": "", "fileNumbering":'incremental'},
              ],
              # 2. additional output writer that writes also the hydrostatic pressure
              "pressure": {   # output files for pressure function space (linear elements), contains pressure values, as well as displacements and velocities
                "OutputWriter" : [
                  {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/"+variables.scenario_name+"/muscle_right_pressure", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                ]
              },
              # 3. additional output writer that writes virtual work terms
              "dynamic": {    # output of the dynamic solver, has additional virtual work values
                "OutputWriter" : [   # output files for displacements function space (quadratic elements)
                  {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.scenario_name+"/muscle_right_dynamic", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                  {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/"+variables.scenario_name+"/muscle_right_virtual_work", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                ],
              },
              # 4. output writer for debugging, outputs files after each load increment, the geometry is not changed but u and v are written
              "LoadIncrements": {
                "OutputWriter" : [
                  {"format": "Paraview", "outputInterval": int(1./variables.dt_elasticity*variables.output_timestep_elasticity), "filename": "out/"+variables.scenario_name+"/muscle_right_load_increments", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                ]
              }
            }
          }
