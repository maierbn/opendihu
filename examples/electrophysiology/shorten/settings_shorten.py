...
üdt_1D = 0.004                      # timestep width of diffusion
    ...
    "Term1": {      # CellML
      "ExplicitEuler" : {
        ...
        "CellML" : {
          ...
          #"compilerFlags": "-hpl=/lustre/cray/ws8/ws/icbakrae-opendihu/opendihu/shorten.pl -fPIC -ftree-vectorize -fopt-info-vec-optimized=vectorizer_optimized.log -shared " # for_usage_with_CCE_and_REVEAL. _ATTENTION:_ACTUALIZE_-hpl_FLAG.
