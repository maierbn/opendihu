...
scenario_name = "l{}_m{}_{}{}{}{}{}".format(max_level, n_fine_grid_fibers, "q" if use_quadratic else "", refinement, "I" if improve_mesh else "n","G" if use_gradient_field else "n", "_neumann" if use_neumann_bc else "_dirichlet")
