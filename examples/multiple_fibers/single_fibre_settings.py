...
def setParameters(n_nodes, time_step_no, current_time, parameters, fibre_no):
  ...
  print("       setParameters at timestep {}, t={}, n_nodes={}, IStim={}, fibre no {}, MU {}, stimulated: {}".\
    format(time_step_no, current_time, n_nodes, parameters[0], fibre_no, getMotorUnitNo(fibre_no), fibre_gets_stimulated))
    ...
    "GodunovSplitting": {
      ...
      "Term2": {     # Diffusion
        "Heun" : {
          ...
          "OutputWriter" : [
            {"format": "Paraview", "outputInterval": 1e4, "filename": "out/bin_"+str(i), "binaryOutput": True, "fixedFormat": False},
            {"format": "Paraview", "outputInterval": 1e4, "filename": "out/txt_"+str(i), "binaryOutput": False, "fixedFormat": False},
            #{"format": "ExFile", "filename": "out/fibre_"+str(i), "outputInterval": 1e4, "sphereSize": "0.02*0.02*0.02"},
            {"format": "PythonFile", "filename": "out/fibre_bin_"+str(i), "outputInterval": 1e4, "binary":True, "onlyNodalValues":True},
            {"format": "PythonFile", "filename": "out/fibre_"+str(i), "outputInterval": 1e4, "binary":False, "onlyNodalValues":True},
          ]
        },
      },
    }
