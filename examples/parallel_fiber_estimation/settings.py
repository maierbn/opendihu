...
config = {
  ...
  "ParallelFiberEstimation" : {
    ...
    "resultFilename": "15x15fibers.bin",
    ...
    "nFineGridFibers": 40,     # number of additional fine fibers that are interpolated between the main "key" fibers, the key fibers are traced
