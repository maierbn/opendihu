...
//ValueType CC<NumberCCPoints>::computeIntegral(const typename std::array<ValueType,numberEvaluations()> &evaluations)
ValueType CC<NumberCCPoints>::computeIntegral(const typename std::array<ValueType,numberEvaluations> &evaluations)
{
  return CC<NumberCCPoints>::template computeIntegral<ValueType>(evaluations.begin());
}
