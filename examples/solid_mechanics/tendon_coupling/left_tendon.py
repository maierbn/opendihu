...
n_elements_left_tendon = variables.n_elements_single_tendon
n_elements_left_tendon[2] = int(n_elements_left_tendon[2]/2)
left_tendon_extent = variables.single_tendon_extent
left_tendon_extent[2] = left_tendon_extent[2]/2
left_tendon_offset = [0,0,0]
...
meshes_tendon = {
  ...
  "tendon_Mesh": {
    "nElements" :         n_elements_left_tendon,
    "physicalExtent":     left_tendon_extent,
    "physicalOffset":     left_tendon_offset,
    "logKey":             "tendon",
  ...
  "tendon_Mesh_quadratic": {
    "nElements" :         [elems // 2 for elems in n_elements_left_tendon],
    "physicalExtent":     left_tendon_extent,
    "physicalOffset":     left_tendon_offset,
...
[nx, ny, nz] = [elem + 1 for elem in n_elements_left_tendon]
[mx, my, mz] = [elem // 2 for elem in n_elements_left_tendon] # quadratic elements consist of 2 linear elements along each axis
...
# neumann bc at k = mz-1 is provided via precice
...
config = {
  ...
  "PreciceAdapter": {        # precice adapter for bottom tendon
      ...
      "preciceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
        {
          "preciceMeshName":      "LeftTendonMesh",            # precice name of the 2D coupling mesh
      ...
      "preciceData": [  
        ...
        },
        {
          ...
          "preciceMeshName":      "LeftTendonMesh",                    # name of the precice coupling surface mesh, as given in the precice xml settings 
