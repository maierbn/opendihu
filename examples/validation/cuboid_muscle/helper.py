...
if "cuboid.bin" in variables.fiber_file:
  ...
  if variables.size_x is not None:
  ...
  if rank_no == 0:
    ...
    with open(variables.fiber_file, "wb") as outfile:
      ...
      # write header
      header_str = "opendihu cuboid version 2       "
      ...
      outfile.write(struct.pack('i', variables.n_fibers_x))   # nBoundaryPointsXNew
      outfile.write(struct.pack('i', variables.n_fibers_y))   # nBoundaryPointsZNew
