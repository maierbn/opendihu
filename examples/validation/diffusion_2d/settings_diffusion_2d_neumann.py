...
config = {
  ...
  "CrankNicolson" : {
    ...
    "OutputWriter" : [
      {"format": "Paraview", "outputInterval": 1000, "filename": "out_neumann/diffusion2d", "binary": True, "fixedFormat": False, "onlyNodalValues": True, "combineFiles": True, "fileNumbering": "incremental"},
      {"format": "PythonFile", "outputInterval": 1000, "filename": "out_neumann/diffusion2d", "binary": True, "onlyNodalValues": True, "combineFiles": True, "fileNumbering": "incremental"}
    ]
  },
}
