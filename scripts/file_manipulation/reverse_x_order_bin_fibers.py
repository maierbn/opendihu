...
# -*- coding: utf-8 -*-
#
# This script reverses the order of the numbering in x direction.
# For .bin files.
#
# usage: reverse_x_order_bin_fibers.py <input filename> [<output filename>]
...
with open(input_filename, "rb") as infile:
  ...
  print("reverse x numbering in file with {} x {} fibers\n".format(n_fibers_x,n_fibers_y))
  ...
  with open(output_filename,"wb") as outfile:
    ...
    for y in range(n_fibers_y):
      for x in reversed(range(n_fibers_x)):
