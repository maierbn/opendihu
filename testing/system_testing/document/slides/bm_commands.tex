% Collection of useful package combinations and commands, contributions of SimTech students 2013,2014, Benjamin Maier
...
%\graphicspath{{images/png/}{images/}{fig/}{figs/}}        % Pfad, in dem sich Grafikdateien befinden
...
\usepackage{movie15}        % \animation{x.mp4}
...
\definecolor{lightyellow}{HTML}{DDDDFF}
\newcommand{\showlog}[1]{%
  \lstinputlisting[breaklines,basicstyle=\tiny,backgroundcolor=\color{yellow}]{#1}%
}
...
\newcommand{\animation}[1]{%
   \includemovie[poster,controls]{\textwidth}{\textwidth}{#1}
}
