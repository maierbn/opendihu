...
../../../../../dependencies/python/install/bin/python3 create_rings.py $input_file $n_rings $min_z $max_z    
...
../../../../../dependencies/python/install/bin/python3 create_mesh.py $triangulation_type $parametric_space_shape $n_points_x
