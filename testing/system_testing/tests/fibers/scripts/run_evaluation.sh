...
#######################################################################################################
triangulation_type=1  # triangulation_type:  0 = scipy, 1 = triangle, 2 = custom (1 is best)
parametric_space_shape=3   # 0 = unit circle, 1 = unit square, 2 = unit square with adjusted grid, 3 = unit circle with adjusted grid
n_points_x=10   # has to be even for quadratic elements
#n_points_x=4
...
#######################################################################################################
triangulation_type=0  # triangulation_type:  0 = scipy, 1 = triangle, 2 = custom (1 is best)
parametric_space_shape=3   # 0 = unit circle, 1 = unit square, 2 = unit square with adjusted grid, 3 = unit circle with adjusted grid
n_points_x=10   # has to be even for quadratic elements
#n_points_x=4
...
#######################################################################################################
triangulation_type=2  # triangulation_type:  0 = scipy, 1 = triangle, 2 = custom (1 is best)
parametric_space_shape=2   # 0 = unit circle, 1 = unit square, 2 = unit square with adjusted grid, 3 = unit circle with adjusted grid
n_points_x=10   # has to be even for quadratic elements
#n_points_x=4
...
#######################################################################################################
triangulation_type=2  # triangulation_type:  0 = scipy, 1 = triangle, 2 = custom (1 is best)
parametric_space_shape=1   # 0 = unit circle, 1 = unit square, 2 = unit square with adjusted grid, 3 = unit circle with adjusted grid
n_points_x=10   # has to be even for quadratic elements
#n_points_x=4
