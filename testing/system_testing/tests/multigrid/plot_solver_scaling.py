...
colors = {
  ...
  "richardson__"+str(column_key_map["duration_1D"]): "gd-.",      # 1D RICHARDSON
  "gmres_"+str(column_key_map["duration_1D"]): "bo:",      # 1D GMRES
  "preonly_"+str(column_key_map["duration_1D"]): "cs--",      # 1D GAMG
  "38o": "gs-",      # 3D
  "39o": "bp-",     # 1D->3D
  "40o": "c<-",      # 3D->1D
  "41o": "bx-",      # file output
...
labels = {
  ...
  "richardson_"+str(column_key_map["duration_1D"]): "solver 1D model (Boomeramg)",      # 1D
  "gmres_"+str(column_key_map["duration_1D"]): "solver 1D model (GMRES)",      # 1D
  "preonly_"+str(column_key_map["duration_1D"]): "solver 1D model (GAMG)",      # 1D
