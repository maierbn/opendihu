...
\begin{frame}
  ...
  \begin{figure}[h!]
    ...
    \begin{subfigure}[t]{0.48\textwidth}%
      \centering%
      \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{../../tests/multiple_fibers/results/fibre_1_.pdf}%
    \end{subfigure}%
    \caption{\lstinline{fibre_1}}
  \end{figure} 
  \showlog{../../tests/multiple_fibers/results/log_recent_fibre_1_.txt}
\end{frame}
%
%===============================================================================
%===============================================================================
