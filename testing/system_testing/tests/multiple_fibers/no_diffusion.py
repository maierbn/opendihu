...
def get_instance_config(i):
  ...
  instance_config = {
    ...
    "Heun" : {
      ...
      "OutputWriter": [
        #{"format": "Paraview", "outputInterval": 1., "filename": "out/fibre_"+str(i), "binary": True, "fixedFormat": False},
        ...
        {"format": "PythonFile", "filename": "out/fibre_"+str(i), "outputInterval": 1, "binary":True, "onlyNodalValues":True},
      ]
    },
  }
