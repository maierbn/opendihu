...
ny = 1
nz = 1
# [1,1,1] = 1 element, 27 dofs per element, 27 dofs, 54 unknowns
...
if "scenario_1" in name:
  ...
  traction = [
    {"element": 0, "face": "0+", "constantValue": tmax/(ly*ly)}   # face can be one of "0+", "0-", "1+", "1-", "2+", "2-". dofValues are the element-local node/dof numbers (e.g. 0-26 for 3D quadratic Lagrange elements), the entries are vectors of dimension D with respect to the local element coordinate system
  ]
