  ...
  "GodunovSplitting": {
    ...
    "Term1": {      # CellML
      "ExplicitEuler" : {
        ...
        "CellML" : {
          "sourceFilename": "hodgkin_huxley_1952.c",             # input C++ source file, can be either generated by OpenCMISS or OpenCOR from cellml model
  ...
  "StrangSplitting": {
    ...
    "Term1": {      # CellML
      "ExplicitEuler" : {
        ...
        "CellML" : {
          "sourceFilename": "hodgkin_huxley_1952.c",
          "simdSourceFilename" : "simdcode.cpp",
          "libraryFilename": "cellml_simd_lib.so",
